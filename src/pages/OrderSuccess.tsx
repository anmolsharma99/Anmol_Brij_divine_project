...
import { CheckCircle2, Download, Home, ShoppingCart, Stamp } from "lucide-react";
      ...
      <div className="container py-10 sm:py-16 max-w-3xl">
        ...
        >
          ...
          <div className="py-4 border-b border-border text-sm">
            ...
            <span className="font-medium capitalize">{order.paymentMethod === "upi" ? "UPI" : order.paymentMethod === "qr" ? "QR Code" : order.paymentMethod === "netbanking" ? "Net Banking" : "Card Payment"}</span>
          ...
          <div className="py-6 flex justify-center">
            <div className="border-4 border-primary/60 rounded-xl px-8 py-4 text-center rotate-[-3deg]">
              ...
              <p className="text-[10px] text-primary/80 tracking-widest uppercase">Officially Verified • Paid</p>
        ...
        >
          ...
          <p className="text-center text-background/50 text-xs mt-6">
            A confirmation has been sent to {order.userEmail || "your email"}. We'll notify you with tracking updates!
          </p>
        </motion.div>
