        ...
        <div className="container relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-primary font-medium tracking-widest text-sm">FOUNDER'S VISION</p>
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-card text-foreground rounded-xl px-6 py-3 shadow-lg">
                <p className="font-display font-bold text-lg">Mr. Anmol Sharma</p>
      ...
      <section className="py-20">
        <div className="container max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-primary font-display font-semibold text-xl">— Mr. Anmol Sharma</p>
          </div>

          <div className="prose prose-lg mx-auto text-muted-foreground">
            <p>
              Growing up in a family deeply connected to Krishna consciousness, I spent countless hours 
              in the lanes of Vrindavan, experiencing the divine energy that flows through this sacred land. 
              Every temple visit, every aarti, every darshan left an indelible mark on my soul.
            </p>
            <p>
              But I realized that millions of devotees around the world yearn to experience this divine 
              ...
              <div key={thakur.name} className="text-center group">
                <div className="relative mb-4">
                  <img
                    src={thakur.image}
                    alt={thakur.name}
                    className="w-24 h-24 md:w-32 md:h-32 rounded-full object-cover mx-auto border-4 border-primary/30 group-hover:border-primary transition-colors"
                  />
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-background/10 backdrop-blur-sm rounded-2xl p-6 text-center">
                <img
                  src={sadhuSaint}
                  alt="Saint"
                  className="w-32 h-32 rounded-full object-cover mx-auto mb-4 border-4 border-primary/30"
                />
                ...
                <p className="text-background/80 text-sm italic">
                  "Guiding ANMOL BRIJ with blessings for spreading Krishna consciousness"
                </p>
              </div>
            ))}
          </div>
